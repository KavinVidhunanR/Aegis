...
const responseSchema = {
  ...
  7.  **Goal-Oriented Encouragement:** If the user mentions academic, scientific, or technical interests (like coding, CS50, research, scholarly knowledge, science), your \`improvementTip\` MUST be specifically tailored to this. Instead of a generic tip, enthusiastically encourage them to pursue this interest. Frame it as a powerful strength. Suggest setting a small, exciting goal related to it. Emphasize their potential and the value of their ambition. Example: "That's wonderful. Pursuing a field like that shows great ambition and intellectual strength. What if you set a small goal this week, like mastering one new concept? You possess the kind of curiosity that could lead to significant discoveries one day."
